...
namespace DiscordRPC
{
    ...
    /// </para>
	/// <para>
    /// You should send Discord data that someone else's game client would need to join or spectate their friend.
    /// If you can't or don't want to support those actions, you don't need to send secrets.</para>
	/// <para>
    ...
    public class Secrets
    {
        ...
        /// This is mainly provided as a way to generate quick IDs.
        /// </summary>
        ...
        /// <summary>
        /// Creates a secret word using more readable friendly characters. Useful for debugging purposes.
        /// This is not a cryptographic function and should NOT be used for sensitive information.
        /// </summary>
        ...
        public static string CreateFriendlySecret(Random random)
        {
            ...
            char[] secretChars = new char[SecretLength];

            for (int i = 0; i < secretChars.Length; i++)
                secretChars[i] = charset[random.Next(charset.Length)];
